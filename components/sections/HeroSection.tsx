...
export function HeroSection() {
  return (
    <section id="hero" aria-labelledby="hero-title" className="relative isolate overflow-x-clip bg-linear-to-b from-brand to-hero-deep to-60% text-center text-white">
      ...
      <div aria-hidden="true" className="relative mx-auto mt-[93px] aspect-[440/454] w-full max-w-[440px] md:mt-[45px] md:aspect-[426/281] md:max-w-[426px]">
        <div className="absolute inset-x-0 top-0 h-[calc(100%+20px)] overflow-hidden [mask-image:linear-gradient(to_bottom,black_calc(100%-24px),transparent)]">
          <div className="relative h-[calc(100%-20px)] origin-top translate-y-3 scale-[1.04]">
